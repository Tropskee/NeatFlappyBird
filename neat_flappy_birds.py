...
BIRD_IMGS = [pygame.transform.scale2x(pygame.image.load(os.path.join("/Users/andrewczeropski/Desktop/Flappy_Birds/My_Flappy_Birds_Tutorial/imgs", "bird1.png"))),
             pygame.transform.scale2x(pygame.image.load(os.path.join("/Users/andrewczeropski/Desktop/Flappy_Birds/My_Flappy_Birds_Tutorial/imgs", "bird2.png"))), 
             pygame.transform.scale2x(pygame.image.load(os.path.join("/Users/andrewczeropski/Desktop/Flappy_Birds/My_Flappy_Birds_Tutorial/imgs", "bird3.png")))]
PIPE_IMG = pygame.transform.scale2x(pygame.image.load(os.path.join(
    "/Users/andrewczeropski/Desktop/Flappy_Birds/My_Flappy_Birds_Tutorial/imgs", "pipe.png")))
BASE_IMG = pygame.transform.scale2x(pygame.image.load(os.path.join(
    "/Users/andrewczeropski/Desktop/Flappy_Birds/My_Flappy_Birds_Tutorial/imgs", "base.png")))
BG_IMG = pygame.transform.scale2x(pygame.image.load(os.path.join(
    "/Users/andrewczeropski/Desktop/Flappy_Birds/My_Flappy_Birds_Tutorial/imgs", "bg.png")))
